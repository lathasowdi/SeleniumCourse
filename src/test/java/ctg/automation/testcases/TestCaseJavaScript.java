...
public class TestCaseJavaScript {
...
Connection nc3 = new Connection( "Omshivaom","namashivaya","F","bliss@gmail.com","1111/11.22.33","CTG","ITSM","Experienced","happy");
		...
		if(statstable.getText(1, 1).equals("Total connections") && statstable.getText(1, 3).toString().equals("16")) {
			System.out.println("There are totally 16");		
		} 
		if(statstable.getText(2, 1).equals("Men") && statstable.getText(2, 3).toString().equals("13")) {
			System.out.println("There are 13 men");		
		}
		if(statstable.getText(3, 1).equals("Women") && statstable.getText(3, 3).toString().equals("3")) {
			System.out.println("There are 3 women");		
		}
menu.OpenConnectionPagepf();
		connectionpage.searchConnectionsByFirstName("Peter");
		
		Thread.sleep(3000);
		System.out.println("The connections page contaiins Peter Parker as a record.");		
}
